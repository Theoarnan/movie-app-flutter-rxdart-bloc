import 'package:movieapps_apitmdb/bloc/get_movies_byGenre_bloc.dart';
import 'package:movieapps_apitmdb/model/movie_response.dart';
import 'package:movieapps_apitmdb/screens/detail_screen.dart';
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          RatingBar(
                            itemSize: 8.0,
                            initialRating:
                                double.tryParse(movies[index].rating) / 2,
                            minRating: 1,
